...
LOCATIONS = {
    ...
    'Marseille': {
        'type': 'box',
        'location': [[43.292980, 5.373702],
                     [43.291188, 5.382210]],
        'start_location': [43.292980, 5.373702]
    },
    'WashingtonPark': {
        'type': 'box',
        'location': [[41.796797, -87.626836],
                     [41.787094, -87.616389]],
        'start_location': [41.795962, -87.625706]
    },
    'EastHarlem': {
        'type': 'box',
        'location': [[40.803601, -73.948124],
                     [40.787315, -73.935341]],
        'start_location': [40.801979, -73.945448]
    },
    'SkidRowLA': {
        'type': 'box',
        'location': [[34.050877, -118.251656],
                     [34.034771, -118.238371]],
        'start_location': [34.049431, -118.249318]
    },
}
